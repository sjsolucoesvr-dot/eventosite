...
import { Plus, Gift, Trash2, DollarSign, QrCode } from "lucide-react";
import { useGifts, useAddGift, useDeleteGift, useGiftPayments, type EventRow } from "@/hooks/useEvent";
    ...
    <div className="space-y-6">
      ...
      <div className="card-premium rounded-2xl p-6">
        ...
        <div className="flex flex-wrap gap-3 items-end">
          ...
          <Button className="rounded-full font-body shrink-0" onClick={handleAdd} disabled={addGift.isPending}><Plus className="w-4 h-4 mr-1" /> Adicionar</Button>
        </div>
      </div>
